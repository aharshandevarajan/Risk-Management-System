      ...
      <div className="flex items-center justify-between px-8 py-6">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="rounded-2xl border border-slate-800/50 bg-slate-900/50 px-6 py-3 backdrop-blur-xl">
            ...
            <div className="text-lg font-black gradient-text-2">
          ...
          <div className="flex items-center gap-4 rounded-2xl border border-slate-800/50 bg-slate-900/50 px-6 py-3 backdrop-blur-xl">
            <div className="text-right">
              ...
              <p className="text-xs font-black uppercase tracking-wider gradient-text">
                {user?.role}
              </p>
            </div>
        ...
        <div className="flex items-center justify-between text-xs">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-slate-400">Threats Monitored: <span className="text-slate-200">24/7</span></span>
            </div>
            <div className="flex items-center gap-2">
              <div className="h-2 w-2 rounded-full bg-purple-500" />
              <span className="font-bold text-slate-400">AI Analysis: <span className="text-slate-200">Active</span></span>
            </div>
            <div className="flex items-center gap-2">
              <div className="h-2 w-2 rounded-full bg-pink-500" />
              <span className="font-bold text-slate-400">Last Scan: <span className="text-slate-200">2 min ago</span></span>
            </div>
          </div>
          <div className="font-bold text-slate-500">
            Version 2.0.0 • Powered by Gemini AI
          </div>
        </div>
      </div>
    </header>
